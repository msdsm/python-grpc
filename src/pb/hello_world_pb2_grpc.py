...
class HelloWorldServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SayHello = channel.unary_unary(
                '/hello_world.HelloWorldService/SayHello',
...
def add_HelloWorldServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'hello_world.HelloWorldService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('hello_world.HelloWorldService', rpc_method_handlers)
